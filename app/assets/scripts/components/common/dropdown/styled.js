...
import { themeVal, stylizeFunction, glsp } from '../../../styles/utils/general';
...
export const DropContent = styled.div`
  ...
  box-shadow: 0 0 0 1px ${themeVal('color.shadow')},
    0 0 32px 2px ${themeVal('color.shadow')},
